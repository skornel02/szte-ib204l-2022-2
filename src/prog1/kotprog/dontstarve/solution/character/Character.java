...
public class Character implements BaseCharacter {
    ...
    private float getHealthSpeedModifier() {
        return getFirstLessBlabla(hp, new float[]{50, 30, 10}, new float[]{1, 0.9F, 0.75F, 0.6F});
    }
    ...
    private float getFoodSpeedModifier() {
        return getFirstLessBlabla(food, new float[]{50, 20, 0}, new float[]{1, 0.9F, 0.8F, 0.5F});
    }
     ...
     */
    private float getFirstLessBlabla(float value, float[] toMatch, float[] result) {
